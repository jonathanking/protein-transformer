"""This script takes a PN processed dictionary, parses out the ID, downloads
the corresponding file from the PDB, then makes a new data dictionary,
akin to the one made by data_aq. """
